...
static void mctp_print_resp_msg(struct mctp_ctrl_resp *ep_discovery_resp,
...
static void mctp_print_req_msg(struct mctp_ctrl_req *ep_discovery_req,
...
static void
mctp_print_routing_table_entry(int routing_id,
...
mctp_ret_codes_t mctp_spi_static_endpoint()
{
	...
	/* HMC Glaicer UUID */
	uuid_table.eid = 0;
	const char raw[16] = { 0xad, 0x4c, 0x83, 0x6b, 0xc5, 0x4c, 0x11, 0xeb,
