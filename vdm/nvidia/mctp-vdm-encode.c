...
bool mctp_encode_vendor_cmd_selftest(struct mctp_vendor_cmd_selftest *cmd)
{
    ...
    encode_vendor_cmd_header(&cmd->vdr_msg_hdr, getRqDgramInst(), MCTP_VENDOR_CMD_SELFTEST);
...
bool mctp_encode_vendor_cmd_downloadlog(struct mctp_vendor_cmd_downloadlog *cmd, uint8_t session)
{
    ...
    encode_vendor_cmd_header(&cmd->vdr_msg_hdr, getRqDgramInst(), MCTP_VENDOR_CMD_DOWNLOAD_LOG);
...
bool mctp_encode_vendor_cmd_bootcmplt(struct mctp_vendor_cmd_bootcmplt *cmd)
{
    ...
    encode_vendor_cmd_header(&cmd->vdr_msg_hdr, getRqDgramInst(), MCTP_VENDOR_CMD_BOOTCOMPLETE);
...
bool mctp_encode_vendor_cmd_hbenable(struct mctp_vendor_cmd_hbenable *cmd)
{
    ...
    encode_vendor_cmd_header(&cmd->vdr_msg_hdr, getRqDgramInst(), MCTP_VENDOR_CMD_ENABLE_HEARTBEAT);
...
bool mctp_encode_vendor_cmd_background_copy(struct mctp_vendor_cmd_background_copy *cmd)
{
    ...
    encode_vendor_cmd_header(&cmd->vdr_msg_hdr, getRqDgramInst(), MCTP_VENDOR_CMD_BG_COPY);
...
bool mctp_encode_vendor_cmd_hbenvent(struct mctp_vendor_cmd_hbenvent *cmd)
{
    ...
    encode_vendor_cmd_header(&cmd->vdr_msg_hdr, getRqDgramInst(), MCTP_VENDOR_CMD_HEARTBEAT);
...
bool mctp_encode_vendor_cmd_restartnoti(struct mctp_vendor_cmd_restartnoti *cmd)
{
    ...
    encode_vendor_cmd_header(&cmd->vdr_msg_hdr, getRqDgramInst(), MCTP_VENDOR_CMD_RESTART);
...
bool mctp_encode_vendor_cmd_bootstatus(struct mctp_vendor_cmd_bootstatus *cmd)
{
    ...
    encode_vendor_cmd_header(&cmd->vdr_msg_hdr, getRqDgramInst(), MCTP_VENDOR_CMD_QUERYBOOTSTATUS);
